api2: Example Application Using Multiple HTML5, Mobile & JAX-RS Technologies 
=========================================================================================================
Author: Jay Balunas
Level: Beginner 
Technologies: CDI, HTML5, REST, JPA
Summary: Based on api2, but uses HTML5, making it suitable for mobile and tablet computers
...
The client application will be running at the following URL <http://localhost:8080/api2/>.
