...
public class MemberService {
    ...
    public Response auth(ApiLoginElement login) {
    	System.err.println(login);
    	return proc(authService.login(login));
    	
    	
    }
    private <T> Response proc(Optional<T> login) {
    ...
    public List<User> listAllMembers() {
		...
		System.err.println("------------------------------------------");
        return repository.findAllOrderedByName2();
    }
